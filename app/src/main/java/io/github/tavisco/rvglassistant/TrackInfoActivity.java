...
//        }
        ...
        if (level.getImagePath() != null) {
            File imgFile = new File(level.getImagePath());
            if (imgFile.isFile() && imgFile.canRead()) {
                carImg = BitmapFactory.decodeFile(level.getImagePath());
                imageSetted = true;
            }
        }
    ...
    private void animateActivityStart() {
        ...
        showTitleAnimator.setListener(new CustomAnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                mTitlesContainer.startAnimation(AnimationUtils.loadAnimation(TrackInfoActivity.this, R.anim.alpha_on));
                ...
                mFabShareButton.animate()
                        .translationX((-1) * Others.pxFromDp(TrackInfoActivity.this, 58))
